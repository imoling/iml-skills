...
iML-PPTX 是一套面向中文商务 PPT 的生产型技能链路。它不是单纯的“写提示词”或“生成 PPT 文件”，而是把需求简报、PPT 图片提示词、页面图片生成、外部视觉取材、可编辑 PPTX 复刻、图标与连接线治理、预览质检串成一条完整工作流。
...
iML-PPTX 是一条中文商务 PPT 的“从想法到可编辑文件”的生产链：先建立视觉参考，再把它重建成可编辑 PPTX，最后用预览截图确认交付质量。
